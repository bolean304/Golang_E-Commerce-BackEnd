...
func NewApplication(prodCollection *mongo.Collection, userCollection *mongo.Collection) *Application {
	return &Application{
		...
		prodCollection: prodCollection, // Corrected this line
	}
}
...
func (app *Application) GetItemFromCart() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		grouping := bson.D{{Key: "$group", Value: bson.D{primitive.E{Key: "_id", Value: "$_id"}, primitive.E{Key: "total", Value: bson.D{{Key: "$sum", Value: "$usercart.price"}}}}}}
